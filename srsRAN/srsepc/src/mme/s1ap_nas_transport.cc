                                                     ...
                                                     struct sctp_sndrcvinfo*               enb_sri)
{
  ...
  switch (msg_type) {
    ...
    case LIBLTE_MME_MSG_TYPE_IDENTITY_RESPONSE:
      ...
      nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_IDENTITY_RESPONSE, nas_ctx, nas_msg.get());
      break;
    case LIBLTE_MME_MSG_TYPE_AUTHENTICATION_RESPONSE:
      ...
      nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_AUTHENTICATION_RESPONSE, nas_ctx, nas_msg.get());
    ...
    case LIBLTE_MME_MSG_TYPE_AUTHENTICATION_FAILURE:
      ...
      nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_AUTHENTICATION_FAILURE, nas_ctx, nas_msg.get());
      break;
    ...
    case LIBLTE_MME_MSG_TYPE_DETACH_REQUEST:
      ...
      nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_DETACH_REQUEST, nas_ctx, nas_msg.get());
      break;
    case LIBLTE_MME_MSG_TYPE_SECURITY_MODE_COMPLETE:
      ...
      if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_CIPHERED_WITH_NEW_EPS_SECURITY_CONTEXT &&
        ...
        nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_SECURITY_MODE_COMPLETE, nas_ctx, nas_msg.get());
      } else {
    ...
    case LIBLTE_MME_MSG_TYPE_ATTACH_COMPLETE:
      ...
      if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_CIPHERED && mac_valid == true) {
        ...
        nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_ATTACH_COMPLETE, nas_ctx, nas_msg.get());
      } else {
    ...
    case LIBLTE_MME_MSG_TYPE_ESM_INFORMATION_RESPONSE:
      ...
      if (sec_hdr_type == LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_CIPHERED && mac_valid == true) {
        ...
        nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_ESM_INFORMATION_RESPONSE, nas_ctx, nas_msg.get());
      } else {
        // Attach Complete was not integrity protected
    ...
    case LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST:
      ...
      nas_ctx->m_contester_nas->handle_sig.emit(LIBLTE_MME_MSG_TYPE_TRACKING_AREA_UPDATE_REQUEST, nas_ctx, nas_msg.get());
      break;
                                                     ...
                                                     struct sctp_sndrcvinfo enb_sri)
{
  ...
  srsran::console("Sending message to eNB with SCTP association %d. MME UE S1AP ID %d, eNB UE S1AP ID %d\n",
                 enb_sri.sinfo_assoc_id,
                 mme_ue_s1ap_id,
                 enb_ue_s1ap_id);
