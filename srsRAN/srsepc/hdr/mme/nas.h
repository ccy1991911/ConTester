...
public:
  ...
  bool pack_guti_reallocation_command(srsran::byte_buffer_t* nas_buffer);
  bool pack_downlink_nas_transport_msg(srsran::byte_buffer_t* nas_buffer);
  ...
  contester_nas*            m_contester_nas = nullptr;
