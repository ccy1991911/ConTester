...
def load_PPN_PUNCT():
    PPN_file_path = '/home/tangd/chen481/ConfTest/graph/code/TD/PPN_in_24.301.txt'
    PPN_list = list()
...
def load_NN_VING():
    nn_to_ving_file_path = '/home/tangd/chen481/ConfTest/graph/code/TD/noun_to_verbing.json'
